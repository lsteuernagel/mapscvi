...
Next predict_query can be used to embed the query data into the latent space of scvi. We have to specify a query path (which defaults to the HypoMap reference which is part of the package) and the number of epochs for training during mapping (10-20 should be sufficient. TODO: test this!).
