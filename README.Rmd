...
query_romanov_neurons = mapscvi::map_new_seurat_hypoMap(mapscvi::query_romanov,suffix="query_romanov_neurons",max_epochs=20)
```
...
```{r}
plot_query_labels(query_seura_object=query_romanov_neurons,reference_seurat=mapscvi::reference_hypoMap_downsample,label_col="C66_named",overlay = FALSE,labelonplot = FALSE)
```
...
```{r}
plot_query_labels(query_seura_object=query_romanov_neurons,reference_seurat=mapscvi::reference_hypoMap_downsample,label_col="C66_named",overlay = TRUE,query_pt_size = 0.4,labelonplot = FALSE,label.size=1)
```
